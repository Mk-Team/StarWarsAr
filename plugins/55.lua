...
return tdcli.sendMessage(msg.to.id, msg.id, 1, '*>* _بلفعل البوت ادمن 👨🏻‍🔧 في هذا المجموعة ✅', 1, "md")
		end
	end, nil)
end
...
return 'مرحباً عزيزي 😃 '..msg.from.first_name..'\n'..[[
...
*>* الاعدادات :– لرؤية اعدادات المجموعة_
