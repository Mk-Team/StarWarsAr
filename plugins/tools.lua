...
tdcli.sendMessage(msg.chat_id_, 0, 1, '*>* _تم ارسال رسالتك 📨  الى_ ['..user_name..'] بنجاح ✅' , 1, 'md')
...
return [[*>* مرحبا عزيزي 😃 في الاوامر العامه الخاصة في المجموعة 🚻 !

*>* م1 :– لعرض اوامر الادارة 🔧
*>* م3 :– لعرض اومر اعادات المجموعة ⚙️
*>* م3 :– لعرض اومر الحماية 🔰
*>* م4 :– لعرض الاوامر العامه في المجموعة 🌐
*>* م المطور :– لعرض الاوامر الخاصه في المطور 🚹
...
*>* _معلومات السيرفر_ :- لعرض معلومات السيرفر
———————————————
قناتنا 📢 :- @WarsTeam
للتواصل 📨 :- @WarsSupportBot
]]
